...
class JumlahWPSuperAdminFragment : Fragment(), AnkoLogger,
    JumlahWPSuperAdminView {
    ...
    override fun getDataKecamatan(dataKecamatan: List<DataModel?>?) {
        if (dataKecamatan != null){
            ...
            for (i in 0..dataKecamatan.size-1){
                superAdminPresenter.getJumlahWP(this.dataKecamatan?.get(i)?.kDKEC.toString())
            }
        }
    }
