package dev.sadewawicak.creativesolusindo.sismiopadmin.superadmin.pbb.menu.sppt.total
...
class TotalSPPTSuperAdminSuperAdminFragment : Fragment(),
    TotalSPPTSuperAdminView,AnkoLogger{

    override fun getSPPTKecamatan(totalsppt: Float, totalspptbayar: Float) {
    ...
    private lateinit var superAdminPresenter: TotalSPPTSuperAdminPresenter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val view = inflater.inflate(R.layout.fragment_total_spptsuperadmin, container, false)

        superAdminPresenter =
            TotalSPPTSuperAdminPresenter(
                context,
    ...
    private fun setData(totalSPPT: ArrayList<Float>, totalSPPTBayar: ArrayList<Float>,i:Int,xValss:String) {
        ...
        values1.add(BarEntry(i.toFloat(), (totalSPPTBayar.get(i)).toFloat()))
        values2.add(BarEntry(i.toFloat(), ((totalSPPT.get(i)-totalSPPTBayar.get(i))).toFloat()))
        xVals.add(xValss)
