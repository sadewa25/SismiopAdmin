...
class TotalSPPTSuperAdminSuperAdminFragment : Fragment(), TotalSPPTSuperAdminView,AnkoLogger{
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        superAdminPresenter = TotalSPPTSuperAdminPresenter(context, APIResponse().response(),this)
